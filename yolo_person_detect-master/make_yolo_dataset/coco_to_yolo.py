...
#注意此处要写绝对路径，便于放在服务器
dataDir = '/root/data/imageData/sjj/voc_coco/diama/make_yolo_dataset/YOLO_VOC2007_2012/COCO'  # COCO数据集所在的路径
dataType = 'train2017'  # 要转换的COCO数据集的子集名
annFile = '%s/annotations/instances_%s.json' % (dataDir, dataType)  # COCO数据集的标注文件路径
classes = get_classes_and_index('./YOLO_VOC2007_2012/COCO/coco_list.txt')
